...
/**
 * Tests the export functionality of the {@link CsvExporter}. In practice, rather than creating new objects within the test methods (such as
 * {@link City}, ...), we would use a mocking framework. However, I decided not to use one for this small example.
 * 
...
public class CsvExporterTest {
    ...
    public void afterMethod() {
        // perform some cleanup before each test method
